...
using static Profile.Domain.RespondQuestionWorkflow.BodyReplay;
...
namespace Test.App
{
    class Program
    {
        ...
        {
            var emailResult = UnverifiedEmail.Create("lung.raul.1998@gmail.com");
            ...
            emailResult.Match(
                    ...
                    Fail: ex =>
                    {
                        Console.WriteLine($"Email  is invalid. Reason: {ex.Message}");
                        return Unit.Default;
                    }
                );
